...
# Switched to ElasticNet Regression (L1 + L2 Regularization)
...
# Alpha (0.01) controls the overall strength. L1_ratio (0.5) sets the mix
# (0=Ridge, 1=Lasso).
...
save_model_results(os.path.basename(__file__), 'ElasticNet', rmse_original)
