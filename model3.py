...
alphas_to_try = [0.1, 1.0, 10.0, 100.0, 1000.0]
...
submission_df.to_csv('submission_ridge_cv.csv', index=False)

print("Submission file 'submission_ridge_cv.csv' created successfully.")
