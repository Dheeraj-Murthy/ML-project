...
from sklearn.linear_model import LinearRegression # Changed from RidgeCV
...
# --- Model Training and Evaluation (Least Squares Solution) ---

# Split the training data for validation
X_train, X_val, y_train, y_val = train_test_split(X_scaled, y, test_size=0.2, random_state=42)

# Initialize and train the pure Linear Regression model (Least Squares)
model = LinearRegression() # Standard Linear Regression uses the Least Squares method
model.fit(X_train, y_train)

print("--- Unregularized Least Squares Results ---")
...
submission_df.to_csv('submission_least_squares.csv', index=False)

print("Submission file 'submission_least_squares.csv' created successfully.")